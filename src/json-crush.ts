...
export const JSONCrush = (string: string, maxSubstringLength = 50): string => {
    ...
    const JSCrush = (string: string, replaceCharacters: string | string[]) => {
        ...
        let substringCount: Record<string, number> = {};
        ...
        while (true) {
            ...
            for (
                ;
                replaceCharacterPos-- && string.includes(replaceCharacters[replaceCharacterPos]);
            ...
            const newSubstringCount: Record<string, number> = {};
            for (const substring in substringCount) {
...
export const JSONUncrush = (string: string): string => {
...
const JSONCrushSwap = (string: string, forward = 1) => {
    ...
    const Swap = (string: string, g: string[]) => {
